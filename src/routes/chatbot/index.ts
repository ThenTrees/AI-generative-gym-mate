 ...
 * @access Public
 */
router.post('/workout-suggestion', (req, res) => chatbotController.workoutSuggestion(req, res));
 ...
 * @access Public
 */
router.post('/nutrition-advice', (req, res) => chatbotController.nutritionAdvice(req, res));
 ...
 * @access Public
 */
router.get('/conversation/:conversationId', (req, res) => chatbotController.getConversation(req, res));
 ...
 * @access Public
 */
router.delete('/conversation/:conversationId', (req, res) => chatbotController.clearConversation(req, res));
